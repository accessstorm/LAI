...
const ProductGuide = () => {
    ...
    return (
        ...
        <head>
            ...
            <link rel="icon" type="image/png" href="LawAIcircle.png" />
        ...
        <body>
            ...
            <div className="page-container">
                ...
                <aside className="sidebar">
                    <h2 className="sidebar-title">LawAI Guide</h2>
                ...
                <main className="main-content">
                    <header className="page-header">
                        <h1>How to Use LawAI</h1>
                        <p>Discover everything you need to know about using our powerful legal document analyzer powered by Google's cutting-edge Gemini 2.0 technology.</p>
                    </header>

                    {/* Getting Started Section */}
                    <section id="getting-started-section" className="content-section active">
                        <h2>Getting Started</h2>
                        <p>Welcome to LawAI! Our tool simplifies legal document analysis by leveraging Google's Gemini 2.0 AI to provide clear, structured insights. Follow these simple steps to begin transforming complex legal documents into accessible information.</p>
                        ...
                        <div className="steps-container">
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>Sign up for LawAI with your professional credentials:</p>
                            ...
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>After verification, you'll receive login details via email. Sign in to access your personalized LawAI dashboard where all your documents and analyses will be stored securely.</p>
                                </div>
                            </div>
                            ...
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>Click the "Upload Document" button on your dashboard to add your legal files. We support multiple formats including PDF, DOCX, TXT, and scanned images. Our Gemini 2.0-powered system will process the document for in-depth analysis.</p>
                                </div>
                            </div>
                            ...
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>Once processing completes, LawAI presents a simplified breakdown of your document with key sections highlighted. Navigate through structured insights including important clauses, potential obligations, risks, and opportunities identified by the AI.</p>
                                </div>
                            </div>
                        ...
                        <div className="card-container">
                            <div className="content-card">
                                ...
                                <div className="card-content">
                                    ...
                                    <p>See how our Gemini 2.0 technology identifies and categorizes key elements within legal documents for faster review.</p>
                                </div>
                            </div>
                            ...
                            <div className="content-card">
                                ...
                                <div className="card-content">
                                    ...
                                    <p>Connect with fellow legal professionals using LawAI to share best practices and specialized workflows.</p>
                                </div>
                            </div>
                    ...
                    <section id="features-section" className="content-section">
                        <h2>Key Features</h2>
                        <p>Discover how LawAI transforms legal document review using Google's advanced Gemini 2.0 AI technology. Our platform offers these powerful capabilities designed specifically for legal professionals.</p>
                        ...
                        <div className="card-container">
                            <div className="content-card">
                                ...
                                <div className="card-content">
                                    ...
                                    <p>Gemini 2.0 parses complex legal documents of any length, automatically identifying key clauses, terms, obligations, and potential issues with human-like understanding.</p>
                                </div>
                            </div>
                    ...
                    <section id="setup-section" className="content-section">
                        ...
                        <p>Follow these detailed steps to configure LawAI for your practice and integrate it with your existing document management workflow. Proper setup ensures optimal AI performance and seamless document analysis.</p>
                        ...
                        <div className="steps-container">
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <ul style={{ marginLeft: '20px', marginBottom: '20px' }}>
                                        ...
                                        <li>List of team members who need LawAI access</li>
                            ...
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>After first login, complete your organizational profile with details about your practice areas, jurisdictions, and document types. This critical information helps Gemini 2.0 tailor its analysis to your specific legal focus.</p>
                                </div>
                            </div>
                            ...
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>Integrate LawAI with your existing document management system. We support seamless connections with leading platforms including Clio, NetDocuments, iManage, and more. Select your platform from "Integrations" and follow the authentication process.</p>
                                </div>
                            </div>
                            ...
                            <div className="step-item">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>Enhance LawAI's understanding by adding industry-specific or client-specific terminology to your customized legal dictionary. Upload specialized glossaries or add terms manually through "Language Settings."</p>
                                </div>
                            </div>
                    ...
                    <section id="tips-section" className="content-section">
                        <h2>Tips & Tricks</h2>
                        <p>Maximize the power of LawAI's Gemini 2.0 technology with these expert tips. These insights will help you get the most accurate and useful structured highlights from your legal document analysis.</p>
                        ...
                        <div className="tips-grid">
                            ...
                            <div className="tip-card">
                                ...
                                <p>Incorporate LawAI into your practice:</p>
                                <ul style={{ marginLeft: '15px', marginTop: '10px' }}>
                    ...
                    <section id="troubleshooting-section" className="content-section">
                        ...
                        <p>Encountering issues with LawAI? Review these common problems and solutions to quickly resolve technical difficulties and optimize your document analysis experience.</p>
                        ...
                        <div className="trouble-item">
                            ...
                            <ol style={{ marginLeft: '20px', marginBottom: '20px' }}>
                                ...
                                <li>Use the "Improve Results" feedback option to help Gemini 2.0 learn</li>
                            </ol>
                        </div>
                        ...
                        <div className="trouble-item">
                            ...
                            <ol style={{ marginLeft: '20px', marginBottom: '20px' }}>
                                ...
                                <li>Verify your DMS version is compatible with LawAI</li>
