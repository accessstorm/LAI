        ...
        <>
            ...
            <div className="page-container">
                ...
                <aside className="sidebar">
                    <h2 className="sidebar-title">LawAI Insights</h2>
                ...
                <main className="main-content">
                    <header className="page-header">
                        <h1>LawAI Insights</h1>
                        <p>Explore legal guides, legislation, and resources powered by Gemini 2.0 to help you understand your uploaded documents.</p>
                    </header>

                    {/* Research Papers Section */}
                    <section id="papers-section" className="content-section active">
                        <h2>Legal Guides & Analysis</h2>
                        <p>Access simplified explanations and structured highlights related to legal concepts and document analysis provided by LawAI.</p>
                        ...
                        <div className="papers-grid">
                            ...
                            <div className="paper-card">
                                <div className="paper-content">
                                    ...
                                    <p className="paper-authors">LawAI Analysis Team</p>
                                    <p className="paper-abstract">This guide provides a simplified overview of common contract clauses, including termination, indemnification, and dispute resolution, as interpreted by LawAI using Gemini 2.0.</p>
                            ...
                            <div className="paper-card">
                                <div className="paper-content">
                                    ...
                                    <p className="paper-authors">LawAI Analysis Team</p>
                                    <p className="paper-abstract">A breakdown of copyright, patents, and trademarks relevant to software development, explained through the lens of LawAI's Gemini 2.0 analysis.</p>
                            ...
                            <div className="paper-card">
                                <div className="paper-content">
                                    ...
                                    <p className="paper-authors">LawAI Analysis Team</p>
                                    <p className="paper-abstract">This guide simplifies the General Data Protection Regulation (GDPR) for small businesses, offering practical steps for compliance as understood by LawAI.</p>
